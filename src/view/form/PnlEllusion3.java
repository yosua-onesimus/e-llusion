...
public class PnlEllusion3 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblStep2Right.setText("<html> Kelompok \"disabled\" terdiri dari huruf:<br><br><br><br> Sedangkan Kelompok \"enabled\" terdiri dari huruf:<br><br><br><br> Huruf di tiap kelompok dapat dibentuk menjadi sebuah kata, yaitu..<br><br> Click [Next] to continue the game. </html>");
